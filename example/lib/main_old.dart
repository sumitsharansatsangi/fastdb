...
class MyAppState extends State<MyApp> {
        ...
        body: Center(
          ...
          child: Column(
            children: [
              ...
              Text("Age: ${FastDB.getPositiveByte('age')}"), // Output: 30
              ...
              Text(
                  "Scores: ${FastDB.getPositiveListByte('scores') ?? [].join(',')}"), // Output: [100, 95, 85]
              Text(
  ...
  Future<void> writeData() async {
    ...
    FastDB.putPositiveListByte('scores', [100, 95, 85]);
